# Module guide:
# - Role: Publish selected project files safely.
...
# Inputs: result: subprocess.CompletedProcess[str]. Outputs and side effects follow the routine contract.
# Keep this boundary focused on one workflow step so it remains easy to test and reuse.
...
# Inputs: script_dir: Path. Outputs and side effects follow the routine contract.
# Keep this boundary focused on one workflow step so it remains easy to test and reuse.
...
# Inputs: repo: Path, raw_files: Sequence[str]. Outputs and side effects follow the routine contract.
# Keep this boundary focused on one workflow step so it remains easy to test and reuse.
...
# Inputs: repo: Path. Outputs and side effects follow the routine contract.
# Keep this boundary focused on one workflow step so it remains easy to test and reuse.
...
# Inputs: repo: Path, allowed_files: set[str]. Outputs and side effects follow the routine contract.
# Keep this boundary focused on one workflow step so it remains easy to test and reuse.
...
# Inputs: repo: Path, base_ref: str, allowed_files: set[str]. Outputs and side effects follow the routine contract.
# Keep this boundary focused on one workflow step so it remains easy to test and reuse.
